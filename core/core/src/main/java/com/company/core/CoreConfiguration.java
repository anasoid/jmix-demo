...
@PropertySource(name = "com.company.core", value = "classpath:/com/company/core/module.properties")
public class CoreConfiguration {
    ...
    public ViewControllersConfiguration screens(final ApplicationContext applicationContext,
        ...
        viewControllers.setBasePackages(Collections.singletonList("com.company.core"));
    ...
    public ActionsConfiguration actions(final ApplicationContext applicationContext,
        ...
        actions.setBasePackages(Collections.singletonList("com.company.core"));
        return actions;
    }
}
